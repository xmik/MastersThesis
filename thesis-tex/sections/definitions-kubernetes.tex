\mysubsec{Trends in IT: microservices, DevOps and Docker containers}
\mysubsec{Kubernetes as a Docker containers orchestration system}
...
~\\
~\\
\mysubsec{Kubernetes architecture}
...
~\\
~\\
\mysubsubsec{Kubernetes cluster}
...
\begin{figure}[H]
    ...
    \label{fig:cluster}
    %\DeclareCaptionLabelFormat{Figure}{ #1: #2}
...
\mysubsubsec{The Kubernetes networking model}

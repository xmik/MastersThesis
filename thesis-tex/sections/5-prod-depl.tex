...
velero
time="2020-06-06T21:14:28Z" level=info msg="All Velero custom resource definitions exist" logSource="pkg/cmd/server/server.go:430"
time="2020-06-06T21:14:28Z" level=info msg="Checking that all backup storage locations are valid" logSource="pkg/cmd/server/server.go:437"
An error occurred: some backup storage locations are invalid: backup store for location "aws" is invalid: rpc error: code = Unknown desc = AccessDenied: Access Denied
	status code: 403, request id: CC9743C5907C62BA, host id: x2q1EH5glcnTS+xUXuz2+dLFBd5r1Apu6qxFu2MLGW7clV7HGqjMmEs4Sugy6TKZyvWmLjjBmts=

$ kubectl logs -n velero velero-6fffc8dc85-2pdh8
